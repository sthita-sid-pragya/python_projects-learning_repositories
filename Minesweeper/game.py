...
class Game():
    def __init__(self, board, screenSize):
        ...
        self.tileSize = self.screenSize[0] // self.board.getSize()[1], self.screenSize[1] // self.board.getSize()[0]
        self.loadImages()
    ...
    def getImage(self, piece):
        string = None
        if (piece.getClicked()):
            string = "explosion" if piece.getHasBomb() else str(piece.getNumAround())
            pass
        else:
